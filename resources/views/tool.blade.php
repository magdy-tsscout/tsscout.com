            ...
            @if (!empty($page['header_1']))
                <div class="con-left">
                    <div class="left-column">
                        ...
                        <p
                            style="color: #1E3F5B; font-size: 13px; font-weight: 550; padding-top: 10px; width: max-content;">
        ...
        $productSchema = [
            ...
            '@graph' => [
                [
                    ...
                    'category' => (string) \Illuminate\Support\Str::of(request()->segment(1) ?? '')
                        ->replace('-', ' ')
                        ->title(),
                    'url' => url()->current(),
                    'mainEntityOfPage' => [
